...
(function() {
  ...
  Environmental = (function() {
    function Environmental(_arg) {
      this.ignore = (_arg != null ? _arg : {}).ignore;
      if (this.ignore == null) {
    ...
    Environmental.prototype.capture = function(file, cb) {
      ...
      return cmd = exec("bash -c 'source " + file + " && env'", options, (function(_this) {
        return function(err, stdout, stderr) {
          var item, key, parts, val, _i, _len, _ref, _ref1;
          if (err) {
          ...
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            ...
            if (_ref1 = !key, __indexOf.call(_this.ignore, _ref1) >= 0) {
              continue;
            }
            if (__indexOf.call(_this.ignore, key) >= 0) {
              continue;
            }
            flat[key] = val;
          }
